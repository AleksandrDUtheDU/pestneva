...
export const cases = [
    {
        ...
        img: marketplejs,
        descr: 'Описание: ООО с сотрудниками, продажа товаров на Озон, ВБ.',
        city: 'Город: Санкт-Петербург',
        price: 'Стоимость обслуживания: ООО УСН Д от 9 000 р',
        services: 'Услуги: бухгалтерское сопровождение, расчет заработной платы',
    },
    {
        id: '2',
        title: 'Стоматологическая клиника',
        img: blagotvoritelnyjFond,
        descr: 'Описание: Стоматологическая клина',
        city: 'Город: Архангельск',
        price: 'Стоимость осблуживания: 35 000 р / ООО УСН Д-Р: 10 400 р',
        services: 'Услуги: бухгалтерское сопровождение  ООО УСН Д-Р, расчет заработной платы сотрудников, кадровый учет, воинский учет, управленческий учет.',
    },
    {
        id: '3',
        title: 'Цветочный магазин',
        img: barMagazin,
        descr: 'Описание: Клиент обратился с момента регистрации ИП. Открыли расчетный счет, зарегистрировали кассу, подключили эквайринг. За год клиент открыл второй магазин, запустил сайт. Подключили интернет-эквайринг, взяли кассу в аренду, оформили прием сотрудника. Наши услуги: бухгалтерское сопровождение ИП УСН Д, расчет заработной платы',
        city: '',
        price: 'Стоимость обслуживания: 9 000 р / ИП УСН Д: от 6 000 р',
        services: 'Услуги: бухгалтерское сопровождение ИП УСН Д, расчет заработной платы',
    },
    {
        id: '4',
        title: 'Поставщик маркетплейсов',
        img: marketplejs,
        descr: 'Описание: у клиента был розничный магазин. Перешел на продажу через маркетплейсы. Восстановили учет за период действия розничного магазина. Внедрили управленческую отчетность. Клиент увеличил количество торговых площадок за год  с Озона до Озон, ВБ, Яндекс. Маркет, Авито.',
        city: 'Город: Москва',
        price: 'Стоимость: 29 000 р',
        services: 'Услуги: ИП УСН Д-Р, 3 расчетных счета, 3 торговых площадки, управленческий учет',
    },
    {
        id: '5',
        title: 'Кафе',
        ...
        descr: '',
        city: '',
        price: 'Стоимость: ИП на ПСН от 6 000 р',
        services: 'Услуги:  Бухгалтерское обслуживание ИП,  Патент',
    },

    {
        ...
        city: 'Город: Мурманск',
        price: 'Стоимость: ответ на требование от 4 500 р',
        services: 'Услуги: декларация УСН, ответ на требование.',
    },
